...
class FreezeManager:
    ...
    """
    def __init__(self, model: nn.Module, freeze_schedule: Dict[int, List[int]]):
        self.model = model
    ...
    def apply_freeze(self, frozen_layers: List[int], trigger_step: int):
        """
        ...
        logger.info(
            f"Freeze applied: {frozen_params_count} parameters frozen, "
            f"{active_params_count} parameters active."
        )
