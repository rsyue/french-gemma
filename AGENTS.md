...
*   **`scripts/run_training.py`**: Configurable, distributed-ready pretraining launcher that supports single-GPU/MPS runs and multi-GPU DDP training. Implements rank-0 data prep, process barriers, and DDP wrapping.
